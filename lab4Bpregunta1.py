...
class lab4Bpregunta1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab4Bpregunta1")
        ...
        self._ac_range = Range(0, 1, 1e-6, 0.25, 200)
        ...
        self._GTX_win = RangeWidget(self._GTX_range, self.set_GTX, "Ganncia de transmisor ", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=lab4Bpregunta1, options=None):
